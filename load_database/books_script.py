...
# Configuration
CSV_FILE_PATH = "/Users/nakiyahdhariwala/share_community/load_database/books_original.csv"  # Update this to your CSV file path
...
DEFAULT_IMAGE_PATH = "/Users/nakiyahdhariwala/share_community/popeye.jpg"  # Path to a default image if none is provided
IMAGE_MAP_FILE = "/Users/nakiyahdhariwala/share_community/load_database/image_map.json"  # File with the image mapping
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                cleaned_date = re.sub(
                                    r"(\d+)(st|nd|rd|th)", r"\1", releasedate
                                )
                                ...
                                print(
                                    f"Warning: Could not parse date '{releasedate}'. Using empty date."
                                )
                                releasedate = ""
