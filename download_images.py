...
# Configuration
CSV_FILE_PATH = "/Users/rishikarandev/Downloads/books_for_db.csv"  # Update this to your CSV file path
IMAGES_DIR = "/Users/rishikarandev/Downloads/book_images"  # Directory to store downloaded images
DEFAULT_IMAGE_PATH = "./harrypotter.jpg"  # Path to a default image if none is provided
IMAGE_MAP_FILE = "/Users/rishikarandev/Downloads/image_map.json"  # File to store the mapping
