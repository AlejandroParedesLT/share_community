...
const Preferences = () => {
  ...
  const handleItemSelect = (itemId) => {
    const item = availableItems.find(i => i.precordsid.toString() === itemId)
    if (item && !selectedItems.some(i => i.precordsid === item.precordsid)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      payload.append("title", "User Preferences")
      payload.append("content", "User selected preferences")
      selectedItems.forEach(item =>
        payload.append("items", item.precordsid.toString())
      )

      const response = await axios.post(`${API_URL}/api/posts/`, payload, {
        headers: {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ maxWidth: "650px", margin: "0 auto", textAlign: "center" }}>
            ...
            />
            <h2 style={{ fontSize: "1.75rem", fontWeight: 600, color: "#1a3c34" }}>Set Your Preferences</h2>
            <p style={{ fontSize: "1rem", color: "#1a3c34", fontWeight: 500 }}>
              Tell us what you like so we can provide better recommendations!
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: "350px" }}>
            <div style={{ textAlign: "center", marginBottom: "2rem" }}>
              ...
              <h2 style={{ fontSize: "1.25rem", fontWeight: 500, color: "#4B5563" }}>Set Your Preferences</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                ...
                <select onChange={(e) => handleItemSelect(e.target.value)} style={{
                  padding: "0.75rem",
                  fontSize: "1rem",
                  ...
                  {availableItems
                    .filter(item => !selectedItems.some(i => i.precordsid === item.precordsid))
                    .map(item => (
              ...
              <ul style={{ listStyle: "none", paddingLeft: 0 }}>
                {selectedItems.map((item, idx) => (
                  <li key={item.precordsid} style={{ marginBottom: "0.5rem" }}>
                    {item.title}
                    <button type="button" onClick={() => handleRemoveItem(idx)} style={{
                      marginLeft: "1rem",
                      background: "none",
                      border: "none",
                      color: "#EF4444",
              ...
              <button
                ...
                onMouseOver={(e) => { e.target.style.backgroundColor = "#b3e5de" }}
                onMouseOut={(e) => { e.target.style.backgroundColor = "#c4ede7" }}
              >
                Save Preferences
              </button>
            </form>
