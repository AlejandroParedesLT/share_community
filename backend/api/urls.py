...
routingUsers.register(r"preferences", PreferenceViewSet)
...
urlpatterns = [
    ...
    path("register/", UserRegisterView.as_view(), name="register"),  # Sign-up endpoint
    # path("preferences/", PreferenceViewSet.as_view(), name="preference-create"),
    ...
    path(
        "chats/<int:pk>/messages/", ChatViewSet.as_view({"get": "messages"})
    ),  # Add this line
]
